...
describe(`${toText.name}()`, () => {
  it('converts data types correctly', () => {
    ...
    expect(toText([
      'a', 5, Symbol('s'), new String('strObj'), new Number(8), [9], {key: 'val'},
      0.0,
      1e10,
      1e-10,
      Infinity,
    ...
    ])).toEqual(`["a",5,Symbol(s),"strObj",8,[9],{key:"val"},0,10000000000,1e-10,Infinity,-Infinity,NaN,"",{},null,undefined,function () {},"1973-03-03T09:46:40.000Z"]`)
  })
